        ...
        <div class="flex h-full bg-blue-900 text-white w-60  py-6 flex-col justify-between">
            ...
            <div class="px-6">
                ...
                <div class="mt-6 space-y-2">
                    ...
                    <a href=" maestro_ panel_de_control.php" class=" flex flex-row justify-center  group">
                    ...
                    <a href="a_panel_de_control.php" class="relative flex flex-row items-center group">
                        ...
                        <div class="absolute hidden group-focus:block top-full min-w-full w-max bg-white  mt-1 rounded">
                            <ul class="text-left border none">
                                <li class=" px-4 py-1 border-b"><a href="a_ingreso_per.php"></a> Permisos </li>
                                <li class=" px-4 py-1"> <a href="a_ingreso_maestro.php"></a> Maestro</li>
                                <li class=" px-4 py-1"><a href="a_ingreso_alumnos.php"></a> Alumnos</li>
                                <li class=" px-4 py-1"><a href="a_ingreso_clases.php"></a> Clases</li>
                            </ul>
